...
> The scripts are applicable to both sexes and all traits—simply change the predicted variable (e.g., from male femur length to female crural index). Additional scripts are omitted to avoid duplication.
